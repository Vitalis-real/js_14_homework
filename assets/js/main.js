...
console.log(evenFn(20)); // [4, 8, 12, 16, 20]
console.log(evenFn(28)); //  [4, 8, 12, 16, 20, 24, 28]
console.log(evenFn(34)); //  [4, 8, 12, 16, 20, 24, 28, 32]
...
function weekFn(n) {
  ...
  switch (n) {
    case 1: string = 'Понедельник'; break;
    case 2: string = 'Вторник'; break;
    case 3: string = 'Среда'; break;
    case 4: string = 'Четверг'; break;
    case 5: string = 'Пятница'; break;
    case 6: string = 'Суббота'; break;
    case 7: string = 'Воскресенье'; break;
    default: string = null;
  }
...
console.log('20', ageClassification(20));
console.log('30', ageClassification(46));
console.log('65', ageClassification(65));
console.log('83', ageClassification(83));
console.log('101', ageClassification(101));
